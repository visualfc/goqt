...
/*!
  ...
  used to create a query string suitable for use in QUrl2::setQuery() from the
  ...
  QUrl2::ComponentFormattingOptions, including query(), which dictate how to
...
public:
    ...
    QString recodeToUser(const QString &input, QUrl2::ComponentFormattingOptions encoding) const;
...
inline QString QUrlQueryPrivate::recodeFromUser(const QString &input) const
{
    ...
    if (qt_urlRecode(output, input.constData(), input.constData() + input.length(),
                     QUrl2::DecodeReserved,
                     prettyDecodedActions))
        return output;
    return input;
}

inline bool idempotentRecodeToUser(QUrl2::ComponentFormattingOptions encoding)
{
    return encoding == QUrl2::PrettyDecoded;
}

inline QString QUrlQueryPrivate::recodeToUser(const QString &input, QUrl2::ComponentFormattingOptions encoding) const
{
    ...
    if (!(encoding & QUrl2::EncodeDelimiters)) {
        QString output;
        if (qt_urlRecode(output, input.constData(), input.constData() + input.length(),
    ...
    : d(0)
{
    ...
    if (url.hasQuery())
        d = new QUrlQueryPrivate(url.encodedQuery());
}
...
static void recodeAndAppend(QString &to, const QString &input,
                            QUrl2::ComponentFormattingOptions encoding, const ushort *tableModifications)
{
...
/*!
    ...
    \sa setQuery(), QUrl2::setQuery(), QUrl2::fragment(), {encoding}{Encoding}
*/
QString QUrlQuery::query(QUrl2::ComponentFormattingOptions encoding) const
{
    if (!d)
        return QString();
...
*/
QList<QPair<QString, QString> > QUrlQuery::queryItems(QUrl2::ComponentFormattingOptions encoding) const
{
    if (!d)
...
*/
QString QUrlQuery::queryItemValue(const QString &key, QUrl2::ComponentFormattingOptions encoding) const
{
    QString result;
    if (d) {
...
*/
QStringList QUrlQuery::allQueryItemValues(const QString &key, QUrl2::ComponentFormattingOptions encoding) const
{
    QStringList result;
    if (d) {
...
/*!
    \fn QString QUrlQuery::toString(QUrl2::ComponentFormattingOptions encoding = QUrl2::PrettyDecoded) const
