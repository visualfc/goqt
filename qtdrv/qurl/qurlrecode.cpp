...
static int recode(QString &result, const ushort *begin, const ushort *end, QUrl2::ComponentFormattingOptions encoding,
        ...
        if (c == '%' && retryBadEncoding) {
            ...
            *output++ = '5';
            ...
            if (decoded >= 0x80) {
                ...
                if (!(encoding & QUrl2::EncodeUnicode) &&
            ...
            decoded = c;
            if (decoded >= 0x80 && encoding & QUrl2::EncodeUnicode) {
...
/*!
    ...
    \list
    \li QUrl2::EncodeDelimiters: if set, delimiters will be left untransformed (note: not encoded!);
                                if unset, delimiters will be decoded
    \li QUrl2::DecodeReserved: if set, reserved characters will be decoded;
                              if unset, reserved characters will be encoded
    \li QUrl2::EncodeSpaces: if set, spaces will be encoded to "%20"; if unset, they will be " "
    \li QUrl2::EncodeUnicode: if set, characters above U+0080 will be encoded to their UTF-8
                             percent-encoded form; if unset, they will be decoded to UTF-16
    \li QUrl2::FullyDecoded: if set, this function will decode all percent-encoded sequences,
    ...
    Other flags are ignored (including QUrl2::EncodeReserved).
             ...
             QUrl2::ComponentFormattingOptions encoding, const ushort *tableModifications)
{
    ...
    if (!(encoding & QUrl2::EncodeDelimiters) && encoding & QUrl2::DecodeReserved) {
        ...
        if (encoding & QUrl2::DecodeReserved)
